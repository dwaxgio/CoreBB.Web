// 9. Mediante comando de EF, se importan las entidades y se configura el contexto de manera automática (en la carpeta Models)
using System;
using System.IO;
    ...
    public partial class CoreBBContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            if (!optionsBuilder.IsConfigured)
            {
                ...
                //                optionsBuilder.UseSqlServer("Server=(LocalDB)\\MSSQLLocalDB;Database=CoreBB;User=sa;Pwd=Unemamad249");
                //12. Se agrega el siguiente código, dado que la cadena de conexión quedó en el archivo appsettings.json
